...
const EditFoodItems = (props) => {
  ...
  const { id } = props.params; // Fixed props spelling
  console.log(id);
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        >
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Edit Food Item</h1>       
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end space-x-3">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="button"
                onClick={() => route.push(`/restaurants/Dashboard`)} // Fixed spelling
